...
export class TaskService {
  ...
  public getPhases(): Promise<Phase[]> {
    return Promise.resolve(this.phases).then(list => list);
  }

  public getPhase(id: number): Promise<Phase> {
    return Promise.resolve(this.phases).then(phases => phases.find(phase => phase.id === id));
  }
